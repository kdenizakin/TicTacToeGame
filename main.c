...
int file_selection_deletion(FILE *filep);
...
int main()
{
    ...
    printf("Type '1' to play 1 vs 1\n");
    printf("Type '2' to play with Computer\n");
//    printf("Type '3' displaying results for player pair or deleting player from file\n");

    scanf("%d",&inp);
    if(inp == 1)
        file_operations_pre(players);
//    else if(inp == 3)
//        file_selection_deletion(filep);
